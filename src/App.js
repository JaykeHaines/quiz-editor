...
function App() {
    ...
    return (<div className="app-container">
      ...
      {jsonData && (<>
          <SettingsEditor settings={jsonData.quizDefinition.settings} onSave={(updatedSettings) => setJsonData((prev) => ({
                ...prev,
                quizDefinition: {
                    ...prev.quizDefinition,
          ...
          {Array.isArray(jsonData.quizDefinition.quiz.content) &&
                jsonData.quizDefinition.quiz.content.map((item, index) => (<div key={index} className="quiz-card">
                <form>
                  <label>Type</label>
                  ...
                  {item['$']?.type === 'choice' && Array.isArray(item.option) && (<div>
                      <label>Options</label>
                      {item.option.map((opt, optIndex) => (<input key={optIndex} className="input" type="text" value={opt} onChange={(e) => {
                                const updated = [...jsonData.quizDefinition.quiz.content];
